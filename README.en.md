...
> Current version: `1.2.0` candidate, intended for npm `latest` and a full GitHub Release. npm package: `dsh-codex-community`.
...
- The complete checks and Linux, macOS, and Windows CI/profile smoke for `1.2.0` will be recorded against this release candidate. Post-release live-account validation starts at `0/13`; see the [acceptance record](docs/releases/v1.2.0.acceptance.json).
