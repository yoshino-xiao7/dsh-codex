...
| Windows x64 | `windows-latest` CI on Node 22 and 24 completes the frozen DSH install, 294 checks, release-draft verification, exact-candidate install, and disposable Web/profile startup | CI automation verified; real user environment pending |
