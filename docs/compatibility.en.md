...
`1.2.1` is the current stable release. Complete checks and Linux, macOS, and Windows CI/profile smoke must be rerun against this candidate and approved by the maintainer. Post-release live-account validation starts at `0/13` and inherits no older evidence.
