...
- Windows、Linux：Node 22/24 CI、冻结 DSH 安装、314 项检查与 Web/profile smoke 已通过
...
- Windows and Linux: Node 22/24 CI, frozen DSH installation, 314 checks, and Web/profile smoke pass
